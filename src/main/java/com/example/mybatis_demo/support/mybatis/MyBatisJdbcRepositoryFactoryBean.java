...
public class MyBatisJdbcRepositoryFactoryBean<T extends Repository<S, ID>, S, ID extends Serializable>
	...
	/**
	 * Creates a new {@link MyBatisJdbcRepositoryFactoryBean} for the given repository interface.
	 *
	 * @param repositoryInterface must not be {@literal null}.
	 */
	public MyBatisJdbcRepositoryFactoryBean(Class<? extends T> repositoryInterface) {
	...
	protected RepositoryFactorySupport doCreateRepositoryFactory() {
		...
		JdbcRepositoryFactory jdbcRepositoryFactory = new MyBatisJdbcRepositoryFactory(dataAccessStrategy, mappingContext,
